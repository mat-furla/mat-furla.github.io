...
<i class="fas fa-info-circle"></i> É importante salientar que esse documento abordará somente o empacotamento para a plataforma **Windows**.
{:.warning}
...
## <i class="fas fa-folder-open"></i> Compreendendo a estrutura
...
## <i class="fas fa-download"></i> Instalando as dependências
...
<i class="fas fa-info-circle"></i> As versões listadas podem mudar conforme a data de instalação.
{:.warning}

## <i class="fas fa-file"></i> Criando o arquivo main.js
...
## <i class="fas fa-code"></i> Adicionando scripts
...
## <i class="fas fa-edit"></i> Modificando index.html
...
## <i class="fas fa-terminal"></i> Usando o electron-packager
...
## <i class="fas fa-download"></i> Instalando o electron-winstaller
...
## <i class="fas fa-file"></i> Criando o arquivo build.js
...
## <i class="fas fa-file"></i> Compilando o executável
...
<i class="fas fa-bullhorn"></i> Apesar do instalador funcionar corretamente e criar um atalho na área de trabalho, o caminho do mesmo estará errado e não abrirá a aplicação.  Recomenda-se verificar o local no qual a aplicação foi instalada e criar o atalho manualmente.
{:.error}
